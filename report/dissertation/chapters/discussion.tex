...
cell with no confident masklet trivially has zero detection accuracy. It is a real, validated estimator for
the after-running, before-labelling operating point, but not the before-running predictor this dissertation
asks for, and not part of the null it reports.
...
\stubfix{3}% final-polish: absorb the ethics overflow
