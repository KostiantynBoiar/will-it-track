...
qualification set out in Section~\ref{sec:meth-targets}, that association may carry little variance
independent of detection, in which case it is reported as the weaker target rather than as an independently
powered test (Chapter~\ref{ch:discussion}).
...
target imagery rather than by its novelty. We promote
