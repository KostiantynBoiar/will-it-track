...
\begin{table}[htbp]\centering
  \caption{Cross-dataset synthesis: every feature tested, per dataset. BURST entries are out-of-sample
  $\Delta$MAE\,($p$); SA-FARI entries are GLM coefficients [95\% CI], except the $\dagger$ rows, which are
  $\Delta$MAE\,($p$). Only animal size clears the bar, and only on SA-FARI.}
